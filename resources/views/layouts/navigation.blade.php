            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @if(auth()->user()->isAdmin())
                        ...
                        <x-nav-link :href="route('admin.specializations.index')" :active="request()->routeIs('admin.specializations.*')">
                            {{ __('Spesialisasi') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(auth()->user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.specializations.index')" :active="request()->routeIs('admin.specializations.*')">
                    {{ __('Spesialisasi') }}
                </x-responsive-nav-link>
